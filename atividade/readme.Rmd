...
author: "Yago da Silva Menezes, Tiago dos Santos Alves e Rosenilda Pereira Barreto </br>"
...
**(b)** Média = 79.85; </br>
Primeiro quartil = 70.0; </br> 
Mediana = 79.5; </br>
Terceiro quartil = 90; </br>
Desvio padrão = 12.78681 </br>
...
**(d)** A variável _peso_ é quantitativa contínua.</br>
A variável _tempo_ é quantitativa discreta </br>
A variável _frango_ é qualitativa nominal </br>
A variável _dieta_ é qualitativa nominal 
...
**(b)** A variável _nome_ é uma variável qualitativa nominal </br>
A variável _altura_ é uma variável quantitativa contínua </br>
A variável _peso_ é uma variável quantitativa contínua 
...
```
Para a altura encontrei </br>
- média = 166 </br>
- mediana = 169 </br>
- desvio padrão = 6.78233

Para o peso encontrei </br>
- média = 67.375 </br>
- mediana = 66.5 </br>
